        ...
        <div>
          ...
          <ul className="mt-5 space-y-3.5 text-sm text-slate-600 dark:text-slate-400">
            <li className="flex items-start gap-2.5">
              ...
              <a href="mailto:info@inovexalabs.com" className="hover:text-blue-600 dark:hover:text-cyan-300 transition-colors">
                info@inovexalabs.com
              </a>
            </li>
            <li className="flex items-start gap-2.5">
              <Phone className="mt-0.5 h-4 w-4 shrink-0 text-blue-600 dark:text-cyan-400" />
              <div className="space-y-1">
                <a href="tel:+917008049087" className="block hover:text-blue-600 dark:hover:text-cyan-300 transition-colors">
                  +91 7008049087 <span className="text-xs text-slate-400 dark:text-slate-500">(India)</span>
                </a>
                <a href="tel:+61433954587" className="block hover:text-blue-600 dark:hover:text-cyan-300 transition-colors">
                  +61-433954587 <span className="text-xs text-slate-400 dark:text-slate-500">(Australia)</span>
                </a>
              </div>
            </li>
            <li className="flex items-start gap-2.5">
